...
public interface ItemService {
	 ...
	 * @return
	 */
	Result addItem(int userId, ItemChangeReason reason, String msg, List<ItemPkg> item);
	 ...
	 * @return
	 */
	Result useItem(int userId, int itemType, int count, ItemChangeReason reason, String msg);
