...
//	@Qualifier("dbcache.max_capacity_of_entity_cache")
	...
	public void setEntityCacheSize(Integer entityCacheSize) {
...
//	@Qualifier("dbcache.max_capacity_of_common_cache")
	...
	public void setCommonCacheSize(Integer commonCacheSize) {
		this.commonCacheSize = commonCacheSize;
	}
	...
	public Object getFromEntityCache(String key) {
		CacheObject cacheObject = this.ENTITY_CACHE.get(key);
		if (cacheObject == null) {
			return null;
		}
