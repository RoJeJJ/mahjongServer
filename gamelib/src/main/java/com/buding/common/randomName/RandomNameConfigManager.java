...
public class RandomNameConfigManager implements InitializingBean {
	private String nameConfigFolder;
	
	private List<Character> firstNames = new ArrayList<Character>();
	private List<Character> manMiddleNams = new ArrayList<Character>();
	private List<Character> manLastNames = new ArrayList<Character>();
	private List<Character> womenMiddleNames = new ArrayList<Character>();
	private List<Character> womenLastNames = new ArrayList<Character>();
